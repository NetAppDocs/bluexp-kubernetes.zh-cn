...
[role="lead"]
在BlueXP (Cloud Manager)中了解Kubelnetes中的新增功能。
...
* link:https://docs.netapp.com/us-en/cloud-manager-kubernetes/task/task-kubernetes-discover-openshift.html["将OpenShift集群导入到Cloud Manager中"]
