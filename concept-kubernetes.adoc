...
通过使用Trident操作员部署的兼容版本的Astra Trident、您可以使用直接管理Kubernetes集群 link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/index.html["BlueXP"^] (以前称为Cloud Manager)。
